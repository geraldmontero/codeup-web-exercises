...
function analyzeColor(color) { if (color = "red"){
    ...
    console.log("Just like a yellow rose")
}else if (color = "green"){
    console.log("Green like my favorite paper")
}else if (color = "blue"){
...
switch (analyzeColor) {
    ...
    case "yellow":
        ...
        break;
    case "green":
        console.log("my favorite paper is green")
        break;
    case "blue":
...
function analyzeColor(color) { if (color === "red"){
    ...
    alert("Just like a yellow rose")
}else if (color ==="green"){
    alert("Green like my favorite paper")
}else if (color === "blue"){
    alert("The sky is also Blue")
}else{
